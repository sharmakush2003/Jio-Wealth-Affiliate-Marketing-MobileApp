...
fun MainNavigation() {
  ...
  NavDisplay(
    ...
    entryProvider =
      entryProvider {
        entry<Onboarding> {
          OnboardingScreen(onFinished = { backStack.add(Login) })
        }
        entry<Login> {
          LoginScreen(
            onLoginSuccess = { 
        ...
        entry<HelpCenter> {
          HelpCenterScreen(onItemClick = { navKey -> backStack.add(navKey) })
        }
...
object FAQData {
  val aboutZillion = listOf(
    FAQItem(
      "What is Mewar Dhani?",
      "Mewar Dhani is a multi-brand loyalty program to reward your routine spending by enabling you to earn Coins across many categories."
    ),
    FAQItem(
      "What are the benefits I get with Mewar Dhani?",
      "We add a splash of excitement to your everyday spends by returning value as coins that can be spent on various rewards."
    ),
    FAQItem(
      "What are the eligibility criteria to become a Mewar Dhani Member?",
      "One should be above the age of 18 years; while some partners are enrolling with specific age limits."
    ),
    FAQItem(
      "How can I enroll in the Mewar Dhani program/membership?",
      "You can enroll for a free membership in the Mewar Dhani loyalty program through its online/offline partner portals."
    ),
    FAQItem(
      "Who are the Mewar Dhani Partners?",
      "We have 50+ in-store and online partners where you can earn and redeem your coins."
    ),
    FAQItem(
      "Where can I find Mewar Dhani partners?",
      "You can find Mewar Dhani Partners on our app & website. Alternately, you could call our customer service center."
    )
  )

  val accountInfo = listOf(
    FAQItem(
      "How do I log in to my new Mewar Dhani Account?",
      "Download the Mewar Dhani app or Visit our website and enter your registered mobile number and OTP."
    ),
    FAQItem(
      "How do I update my account?",
      "Contact us at support@mewardhani.in for any help with your Mewar Dhani account, and we will update it for you."
    ),
    FAQItem(
      "Can I transfer my Mewar Dhani Account to another person’s name?",
      "Once Mewar Dhani Membership is issued to an individual, the same cannot be transferred to anyone else."
    ),
    FAQItem(
      "How can I cancel my Mewar Dhani Membership/account?",
      "A member may terminate his/her Mewar Dhani Membership by reaching out to us via the customer care support."
    ),
    FAQItem(
  ...
  val zillionCoins = listOf(
    FAQItem(
      "How do I earn Mewar Dhani Coins?",
      "It is super easy and quick. You can earn Coins by transacting on the Mewar Dhani platform or clicking out to partners."
    ),
    FAQItem(
      "When are the Coins credited?",
      "Mewar Dhani Coins get credited instantly in most cases, however on transactions done at a few partners it can take up to 7 days."
    ),
    FAQItem(
  ...
  val redemptionInfo = listOf(
    FAQItem(
      "How long will it take to receive a product redeemed from the Mewar Dhani Catalog?",
    ...
    FAQItem(
      "How long will it take to receive a voucher redeemed from the Mewar Dhani Catalog?",
    ...
    FAQItem(
      ...
      "Product Orders placed through the Mewar Dhani Catalog can be canceled only by contacting us within 2 hours of booking."
    ),
    FAQItem(
      "Can I request the product be shipped to an alternate mailing address?",
      "Please log in to your account on the Mewar Dhani App or Website to update your mailing address before ordering."
    )
  )
}
